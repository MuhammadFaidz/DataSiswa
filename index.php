...
<div class="container">
    <div class="form-container">
        <h3 class="text-center mt-5">Masukan Data Siswa</h3>
        <div class="d-flex justify-content-center">
            <form method="post" class="add-data d-flex justify-content-center flex-column mb-5">
        ...
        <hr>
            ...
            <?php endif; ?>
            <thead>
                <tr class="table-container table-dark" style="text-align: center;">
                    <th scope="col">No</th>
